  ...
  return (
        ...
        <div>
          <div className="mx-auto max-w-6xl px-6 lg:px-8 ">
            <div className="mt-16 flow-root sm:mt-24">
              ...
              <Image src="/dashboard-preview.jpg" alt="product preview" width={1364} height={866} quality={100} className="rounded-md p-2 bg-white shadow-2xl ring-1 ring-gray-900/10 sm:p-8 md:p-20"/>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="mx-auto mt-32 mb-32 sm:mt-56 max-w-5xl">
      <div className="mb-12 px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="text-lg mt-4 text-gray-600">
            Chatting to your PDF files have never been easier that with Auditor.
          </p>
        </div>
      </div>
      ...
      <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
        ...
        <li className="md:flex-1">
          <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4 ">
            <span className="text-blue-600 text-sm font-medium">Step 3</span>
            <span className=" text-xl font-semibold">Start asking questions</span>
            <span className=" mt-2 text-zinc-700">  
              It&apos;s that simple. Try out Auditor today - it really takes less than a minute to get started.
            </span>
          </div>
        </li>
      </ol>
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8 ">
            <div className="mt-16 flow-root sm:mt-24">
              <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:p-4 lg:rounded-2xl">
              <Image src="/file-upload-preview.jpg" alt="uploading preview" width={1419} height={732} quality={100} className="rounded-md p-2 bg-white shadow-2xl ring-1 ring-gray-900/10 sm:p-8 md:p-20"/>
              </div>
            </div>
          </div>
    </div>
